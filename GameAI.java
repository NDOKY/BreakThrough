/**
 * Minimax with alpha-beta pruning. Chooses a move within the given time limit (e.g. 5 seconds).
 */
public final class GameAI {
     ...
     * Stops when elapsed time exceeds limitMs. limitMs is a duration (e.g. 4900 to stay under 5 seconds).
     */
    ...
    private static int alphaBeta(Board board, int depth, int alpha, int beta, Mark currentPlayer, Mark maximizingPlayer,
